  ...
  render() {
    ...
    const childrenData = [
      ...
      },
      {
        ...
        text: `<h3>工作</h3>还是一部分时间的研发岗，不过从厂里出来相对的更懂得所想所要，也就更偏向于兴趣和商业齐驱的创业项目。人出来了、长大了总要去做些感动人心的产品才能有所怀念。这一点，记得好像听雷总说过，永远相信美好的事情即将发生！当然，度厂长也在年会上说过类似的话：“前方，我们的征途真的是星辰大海！”
